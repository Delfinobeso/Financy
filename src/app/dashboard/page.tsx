  ...
  return (
    <div className="flex flex-col flex-1 max-w-lg mx-auto w-full px-6 pb-24">
      <header className="py-8">
        ...
        <div className="bg-surface border border-border rounded-2xl p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-muted text-xs tracking-wider mb-1">
                Rimanente
              </p>
      ...
      <section className="mb-8">
        <h2 className="text-xs tracking-wider text-muted mb-4">
          Categorie
        </h2>
            ...
            return (
              <div
                ...
                className={`bg-surface border rounded-xl p-4 transition-all ${
                  isHighlighted
                    ? "border-accent/50 shadow-[0_0_24px_var(--color-accent-muted)]"
                    : "border-border"
                }`}
              ...
              >
                ...
                <div
                  ...
                  aria-valuemin={0}
                  aria-valuemax={100}
                  aria-label={`${category.name}: ${Math.round(pct)}%`}
                >
                  <div
        ...
        {recentExpenses.length === 0 ? (
          <div className="py-12 text-center">
            ...
            <p className="text-muted text-sm">
              Il tuo budget è intatto
            </p>
            <p className="text-muted/50 text-xs mt-1">
              Aggiungi la prima spesa per iniziare a tracciare
            </p>
          </div>
        ) : (
      ...
      {showResetDialog && (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          >
            <h3 id="reset-title" className="text-lg font-semibold tracking-tight mb-2">
              Resettare tutti i dati?
            </h3>
            <p id="reset-desc" className="text-muted text-sm mb-6">
              Il budget e tutte le spese saranno eliminati. Questa azione non è reversibile.
            </p>
